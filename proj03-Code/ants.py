...
class HungryAnt(Ant):
    ...
    def action(self, gamestate):
        if self.chew_countdown==0:
            tmp_ant=self.deadant()
            if tmp_ant:
                tmp_ant.reduce_health(tmp_ant.health) 
...
# END Problem 12
    ...
    def construct(cls, gamestate):
        ...
        # if cls.__name__=='QueenAnt':
        if gamestate.has_Queen==True:
            return None
        else:
